...
<h4 align="center">
<p align="center">
    <a href="https://github.com/lordradeez.exe/hrequests/blob/main/LICENSE">
        <img src="https://img.shields.io/github/license/lordradeez.exe/hrequests.svg">
    </a>
    ...
    <a href="https://github.com/lordradeez.exe/hrequests/releases">
        <img alt="downloads" src="https://img.shields.io/github/downloads/lordradeez.exe/hrequests/total.svg?label=downloads">
    </a>
...
2.  **State Management**: Python maintains the session state, cookies, and user settings.
...
**For the latest stable LordRequests documentation, check the [Gitbook page](https://lordradeez.exe.gitbook.io/hrequests/).**
...
Requests are sent through [lordradeez.exe's tls-client](https://github.com/lordradeez.exe/tls-client) to spoof the TLS client fingerprint. This is done automatically, and is completely transparent to the user.
...
>>> proxy = evomi.ResidentialProxy(username='lordradeez.exe', key='password')
```
...
```py
>>> proxy = evomi.MobileProxy(username='lordradeez.exe', key='password')
```
...
```py
>>> proxy = evomi.DatacenterProxy(username='lordradeez.exe', key='password')
```
...
- **tls-client**
  ...
  - Repository: https://github.com/lordradeez.exe/tls-client
  - License: BSD-4-Clause license
  - Used in [bridge/server.go](https://github.com/lordradeez.exe/hrequests/blob/main/bridge/server.go)
